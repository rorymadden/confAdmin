...
$templateCache.put('agendas/agendas.html','<div ui-view>\n  <md-toolbar class="md-table-toolbar md-accent">\n    <div class="md-toolbar-tools">\n      <span>Agendas</span>\n      <span flex></span>\n      <!-- <md-switch ng-model="agendas.activeFlag" aria-label="Active Switch" class="md-primary" >\n        {{ agendas.activeFlag | activeStatus}}\n      </md-switch> -->\n      <span ng-bind-html="agendas.activeFlag | booleanFlag" ng-click="agendas.toggleActive()"></span>\n      <md-icon md-font-set="material-icons" ng-click="agendas.openAgendaDialog()">add_box</md-icon>\n    </div>\n  </md-toolbar>\n\n  <!-- exact table from live demo -->\n  <md-table-container>\n    <!-- <table md-table md-row-select multiple ng-model="selected" md-progress="promise"> -->\n    <table md-table md-row-select multiple ng-model="selected" id="agendaList">\n      <!-- <thead md-head md-order="agendas.order" md-on-reorder="getDesserts"> -->\n      <thead md-head md-order="agendas.query.order">\n        <tr md-row>\n          <th md-column><span>Name</span></th>\n          <th md-column>Sessions</th>\n          <th md-column class="th-edit">Primary</th>\n          <th md-column class="th-edit">Edit</th>\n        </tr>\n      </thead>\n      <tbody md-body>\n        <tr md-row md-select="agenda" md-select-id="_id" md-auto-select ng-repeat="agenda in agendas.agendas | activeFlag:agendas.activeFlag | orderBy: \'order\'">\n          <td md-cell>{{agenda.name}}</td>\n          <td md-cell>{{agenda.sessions.length}}</td>\n          <td md-cell ng-bind-html="agenda.primary | booleanFlag" ng-click="agendas.confirmPrimary($event, agenda)"></td>\n          <td md-cell>\n            <a ui-sref="conference.agendas.agenda({agendaId: agenda._id})"><md-icon md-font-set="material-icons">edit</md-icon></a>\n            <a ng-click="agendas.copyAgenda($event, agenda)"><md-icon md-font-set="material-icons" alt="copy">flip_to_front</md-icon></a>\n            <a ng-click="agendas.removeAgenda($event, agenda)" ng-show="agenda.active"><md-icon md-font-set="material-icons">remove_circle</md-icon></a>\n            <a ng-click="agendas.reactivateAgenda(agenda)" ng-show="!agenda.active"><md-icon md-font-set="material-icons">undo</md-icon></a>\n          </td>\n        </tr>\n      </tbody>\n    </table>\n  </md-table-container>\n\n  <md-table-pagination md-limit="agendas.query.limit" md-limit-options="[30, 50, 100]" md-page="agendas.query.page" md-total="{{agendas.agendas.count}}" md-page-select></md-table-pagination>\n\n</div>\n');
$templateCache.put('attendees/attendeeForm.html','<div>\n  <md-toolbar>\n    <div class="md-toolbar-tools">\n      <h2>Attendee Details</h2>\n      <span flex></span>\n      <md-button class="md-icon-button" ui-sref="conference.attendees">\n        <md-icon md-font-set="material-icons">close</md-icon>\n      </md-button>\n    </div>\n  </md-toolbar>\n  <form name="attendeeCtrl.attendeeForm" ng-submit="attendeeCtrl.saveAttendee()">\n    <md-content layout-padding="">\n      <div layout-gt-sm="row">\n        <md-input-container class="md-block" flex-gt-sm>\n          <label>First Name</label>\n          <input ng-model="attendeeCtrl.attendee.first" required name="first">\n          <div ng-messages="attendeeCtrl.attendeeForm.first.$error" role="alert">\n            <div ng-message-exp="[\'required\']">\n              A first name is required.\n            </div>\n          </div>\n        </md-input-container>\n        <md-input-container class="md-block" flex-gt-sm>\n          <label>Last Name</label>\n          <input ng-model="attendeeCtrl.attendee.last" required name="last">\n          <div ng-messages="attendeeCtrl.attendeeForm.last.$error" role="alert">\n            <div ng-message-exp="[\'required\']">\n              A last name is required.\n            </div>\n          </div>\n        </md-input-container>\n      </div>\n\n      <div layout-gt-sm="row">\n        <md-input-container class="md-block" flex-gt-sm>\n          <label>Job Title</label>\n          <input ng-model="attendeeCtrl.attendee.jobTitle" required name="jobTitle">\n          <div ng-messages="attendeeCtrl.attendeeForm.jobTitle.$error" role="alert">\n            <div ng-message-exp="[\'required\']">\n              A job title is required.\n            </div>\n          </div>\n        </md-input-container>\n        <md-input-container class="md-block" flex-gt-sm>\n          <label>Company</label>\n          <input ng-model="attendeeCtrl.attendee.company" required name="company">\n          <div ng-messages="attendeeCtrl.attendeeForm.company.$error" role="alert">\n            <div ng-message-exp="[\'required\']">\n              A company is required.\n            </div>\n          </div>\n        </md-input-container>\n      </div>\n\n      <md-input-container class="md-block">\n        <label>Country</label>\n        <md-select ng-model="attendeeCtrl.attendee.country">\n          <md-option ng-repeat="country in attendeeCtrl.countries" value="{{country.code}}">\n            {{country.country}}\n          </md-option>\n        </md-select>\n      </md-input-container>\n\n\n      <md-input-container class="md-block" flex-gt-sm>\n        <label>Role</label>\n        <md-select ng-model="attendeeCtrl.attendee.role">\n          <md-option ng-repeat="role in attendeeCtrl.roles"  value="{{role}}">\n            {{role}}\n          </md-option>\n        </md-select>\n      </md-input-container>\n\n      <md-input-container class="md-block" flex-gt-sm>\n        <label>TitoId</label>\n        <input ng-model="attendeeCtrl.attendee.titoId" required name="titoId">\n        <div ng-messages="attendeeCtrl.attendeeForm.titoId.$error" role="alert">\n          <div ng-message-exp="[\'required\']">\n            A titoId is required.\n          </div>\n        </div>\n      </md-input-container>\n\n\n      <!-- <div layout-gt-sm="row"> -->\n        <!-- <md-input-container class="md-block" flex-gt-sm>\n          <label>Twitter</label>\n          <input ng-model="attendeeCtrl.attendee.twitter" name="twitter">\n          <div ng-messages="attendeeCtrl.attendeeForm.twitter.$error" role="alert">\n            <div ng-message-exp="[\'url\']">\n              You must start with https://\n            </div>\n          </div>\n        </md-input-container>\n        <md-input-container class="md-block" flex-gt-sm>\n          <label>LinkedIn</label>\n          <input ng-model="attendeeCtrl.attendee.linkedIn" type="url" name="linkedIn">\n          <div ng-messages="attendeeCtrl.attendeeForm.linkedIn.$error" role="alert">\n            <div ng-message-exp="[\'url\']">\n              You must start with https://\n            </div>\n          </div>\n        </md-input-container> -->\n        <!-- <md-input-container class="md-block" flex-gt-sm>\n          <label>Instagram</label>\n          <input ng-model="attendeeCtrl.attendee.social.instagram" type="url" name="instagram">\n          <div ng-messages="attendeeCtrl.attendeeForm.instagram.$error" role="alert">\n            <div ng-message-exp="[\'url\']">\n              You must start with https://\n            </div>\n          </div>\n        </md-input-container>\n        <md-input-container class="md-block" flex-gt-sm>\n          <label>Github</label>\n          <input ng-model="attendeeCtrl.attendee.social.github" type="url" name="github">\n          <div ng-messages="attendeeCtrl.attendeeForm.github.$error" role="alert">\n            <div ng-message-exp="[\'url\']">\n              You must start with https://\n            </div>\n          </div>\n        </md-input-container> -->\n      <!-- </div> -->\n    </md-content>\n    <md-actions layout="row">\n      <span flex></span>\n      <md-button class="md-raised md-danger" ui-sref="conference.attendees">Cancel</md-button>\n      <md-button class="md-raised md-primary" type="submit" md-autofocus>Save</md-button>\n    </md-actions>\n  </form>\n</div>\n');
$templateCache.put('attendees/attendees.html','<div ui-view>\n  <md-toolbar class="md-table-toolbar md-accent">\n    <div class="md-toolbar-tools">\n      <span>Attendees</span>\n      <span flex></span>\n      <!-- <md-switch ng-model="attendees.activeFlag" aria-label="Active Switch" class="md-primary" >\n        {{ attendees.activeFlag | activeStatus}}\n      </md-switch> -->\n      <span ng-bind-html="attendees.activeFlag | booleanFlag" ng-click="attendees.toggleActive()"></span>\n      <a ui-sref="conference.attendees.new"><md-icon md-font-set="material-icons">add_box</md-icon></a>\n    </div>\n  </md-toolbar>\n\n  <!-- exact table from live demo -->\n  <md-table-container>\n    <!-- <table md-table md-row-select multiple ng-model="selected" md-progress="promise"> -->\n    <table md-table md-row-select multiple ng-model="selected" id="attendeeList">\n      <!-- <thead md-head md-order="attendees.order" md-on-reorder="getDesserts"> -->\n      <thead md-head md-order="attendees.query.order">\n        <tr md-row>\n          <th md-column><span>First</span></th>\n          <th md-column><span>Last</span></th>\n          <th md-column><span>Title</span></th>\n          <th md-column><span>Company</span></th>\n          <th md-column><span>Country</span></th>\n          <th md-column md-desc>Order</th>\n          <th md-column class="th-edit">Edit</th>\n          <th md-column class="th-edit">Images</th>\n        </tr>\n      </thead>\n      <tbody md-body>\n        <tr md-row md-select="attendee" md-select-id="_id" md-auto-select ng-repeat="attendee in attendees.attendees | activeFlag:attendees.activeFlag | orderBy: \'order\'">\n          <td md-cell>{{attendee.first}}</td>\n          <td md-cell>{{attendee.last}}</td>\n          <td md-cell>{{attendee.jobTitle}}</td>\n          <td md-cell>{{attendee.company}}</td>\n          <td md-cell>{{attendee.country | countryCode}}</td>\n          <td md-cell><input type="number" ng-model="attendee.order" ng-change="attendees.saveAttendee(attendee)"></td>\n          <td md-cell>\n            <a ui-sref="conference.attendees.attendee({attendeeId: attendee._id})"><md-icon md-font-set="material-icons">edit</md-icon></a>\n            <a ng-click="attendees.removeAttendee($event, attendee)" ng-show="attendee.active"><md-icon md-font-set="material-icons">remove_circle</md-icon></a>\n            <a ng-click="attendees.reactivateAttendee(attendee)" ng-show="!attendee.active"><md-icon md-font-set="material-icons">undo</md-icon></a>\n          </td>\n          <td md-cell>\n            <span ng-bind-html="attendee.profilePic | photoIcon:\'Profile Pic\':\'person_pin\'" ng-click="attendees.toggleImage(attendee, \'profilePic\', attendee.first + \' \' + attendee.last + \': \' + attendee.company)"></span>\n            <span ng-bind-html="attendee.companyLogo | photoIcon:\'Company Logo\':\'business\'" ng-click="attendees.toggleImage(attendee, \'companyLogo\', attendee.company)"></span>\n          </td>\n        </tr>\n      </tbody>\n    </table>\n  </md-table-container>\n\n  <md-table-pagination md-limit="attendees.query.limit" md-limit-options="[30, 50, 100]" md-page="attendees.query.page" md-total="{{attendees.attendees.count}}" md-page-select></md-table-pagination>\n\n</div>\n');
$templateCache.put('conference/conference.html','<md-sidenav class="md-sidenav-left" md-component-id="left"  md-disable-backdrop  md-whiteframe="4">\n  <user-widget user="conf.user"></user-widget>\n\n  <md-list>\n    <md-list-item ui-sref="conference({conference: app.conference})" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">dashboard</md-icon>\n        Dashboard\n    </md-list-item>\n\n    <!-- <md-list-item ui-sref="conference.streams" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">rowing</md-icon>\n          Streams\n    </md-list-item> -->\n\n    <md-list-item ui-sref="conference.speakers" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">record_voice_over</md-icon>\n          Speakers\n    </md-list-item>\n\n\n    <md-list-item ui-sref="conference.sponsors" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">repeat</md-icon>\n          Sponsors\n    </md-list-item>\n\n\n    <md-list-item ui-sref="conference.agendas" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">today</md-icon>\n          Agendas\n    </md-list-item>\n\n\n    <md-list-item ui-sref="conference.sessions" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">airplay</md-icon>\n          Sessions\n    </md-list-item>\n\n    <md-list-item ui-sref="conference.attendees" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">people</md-icon>\n          Attendees\n    </md-list-item>\n\n    <md-list-item ui-sref="conference.media" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">signal_wifi_4_bar</md-icon>\n          Media\n    </md-list-item>\n\n    <md-list-item ui-sref="conference.details" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">assignment</md-icon>\n          Conference Details\n    </md-list-item>\n\n    <md-list-item ui-sref="conference.venues" ui-sref-active="active">\n        <md-icon md-font-set="material-icons">account_balance</md-icon>\n          Venues\n    </md-list-item>\n\n  </md-list>\n</md-sidenav>\n\n<md-content flex layout-padding>\n\n  <div ui-view class="contentView">\n    <h1>Dashboard</h1>\n    <p>This is where the magic will happen!</p>\n\n  </div>\n</md-content>\n');
...
var API_URL = 'https://conf.sociallymotivated.com';
var APP_URL = 'http://admin.sociallymotivated.com';
...
angular.module('constants', [])
  ...
  .constant('ROLES', ['Business Analyst', 'Designer', 'Developer', 'DevOps / System Admin', 'Marketer', 'Product Owner', 'Project Manager', 'Tester / QA', 'Founder',])
  .constant('CLOUDINARY', {
    cloud_name: 'initiate',
...
.controller('AgendasCtrl', function (agendas, Restangular, $state, $stateParams, $mdDialog, $rootScope) {
  ...
  this.confirmPrimary = function(ev, agenda) {
    ...
    var confirm = $mdDialog.confirm()
          ...
          .ariaLabel('Set Agenda as Primary')
          .targetEvent(ev)
          .ok('Yes')
          .cancel('Cancel');
    $mdDialog.show(confirm).then(function() {
      ...
      agenda.one('setPrimary').put().then(function () {
      }, function (err) {
        agenda.primary = !agenda.primary;
  ...
  this.copyAgenda = function(ev, agenda) {
    // Appending dialog to document.body to cover sidenav in docs app
    var confirm = $mdDialog.confirm()
          .title('Confirm Copy')
          .textContent('Confirm copy of ' + agenda.name)
          .ariaLabel('Copy Agenda')
          .targetEvent(ev)
          .ok('Yes')
          .cancel('Cancel');
    $mdDialog.show(confirm).then(function() {

      agenda.one('copy').put().then(function (agenda) {
        self.agendas.push(agenda);
      }, function (err) {
        $mdDialog.show(
           $mdDialog.alert()
  ...
  this.openAgendaSessionDialog = function(ev, agendaSession) {
    ...
    .then(function(agendaSession) {
      if(agendaSession._id) {
        var session = {
          start: new Date(agendaSession.start).getTime(),
          duration: agendaSession.duration,
          sessionId: agendaSession.sessionId,
          sessionType: agendaSession.sessionType
        }
        Restangular.one('conferences', $stateParams.confId).one('agendas', self.agenda._id).one('sessions', agendaSession._id).customPUT(session).then(function (agenda) {
          self.agenda = agenda;
        });
      }
      else {
...
'use strict';
// import attendeesTemplate from './attendees.html';
// import attendeeFormTemplate from './attendeeForm.html';
...
.config(function ($stateProvider) {
  ...
  $stateProvider
    .state('conference.attendees', {
      url: '/attendees',
      // templateUrl: attendeesTemplate,
      templateUrl: 'attendees/attendees.html',
      controller: 'AttendeesCtrl as attendees',
      resolve: {
        $title: function () { return 'Attendees'; },
        attendees: function (Restangular, $stateParams) {
          'ngInject';
          return Restangular.one('conferences', $stateParams.confId).all('attendees').getList();
        }
      }
    })
    .state('conference.attendees.new', {
      url: '/new',
      // templateUrl: attendeeFormTemplate,
      templateUrl: 'attendees/attendeeForm.html',
      controller: 'AttendeeFormCtrl as attendeeCtrl',
      resolve: {
        $title: function () { return 'Create a New Attendee'; },
        attendee: function () { return {} }
      },


    })
    .state('conference.attendees.attendee', {
      url: '/:attendeeId',
      // templateUrl: attendeeFormTemplate,
      templateUrl: 'attendees/attendeeForm.html',
      controller: 'AttendeeFormCtrl as attendeeCtrl',
      resolve: {
        attendee: function (Restangular, $stateParams) {
          'ngInject';
          return Restangular.one('conferences', $stateParams.confId).one('attendees', $stateParams.attendeeId).get(function (attendee) {
            return attendee;
          });


        },
        // $title: function () { return 'Edit Attendee: ' + attendee.first + ' ' + attendee.last; },
        $title: function () { return 'Edit Attendee'; },
      }
    })
    ;
})
.controller('AttendeesCtrl', function (attendees, Restangular, $state, $stateParams, $mdMedia, $mdDialog, $rootScope, imageService) {
  'ngInject';
  var self = this;
  // this.attendees = Restangular.copy(attendees);
  this.attendees = attendees;

  $rootScope.$on('attendeeChange', function (event, attendee) {
    var newAttendee = true;
    self.attendees.map(function (s, index) {
      if(s._id === attendee._id) {
        newAttendee = false;
        self.attendees.splice(index, 1, attendee);
      }
    });
    if (newAttendee) self.attendees.push(attendee);
  });
  $rootScope.$on('removedAttendee', function (event, attendee) {
    self.attendees = self.attendees.filter(function (s) {
      if(s._id !== attendee._id) return true;
    });
  });
  ...
  this.removeAttendee = function(ev, attendee) {
    // Appending dialog to document.body to cover sidenav in docs app
    var confirm = $mdDialog.confirm()
          .title('Confirm De-activation')
          .textContent('Confirm de-activation of ' + attendee.first + ' ' + attendee.last)
          .ariaLabel('Attendee De-activation')
          .targetEvent(ev)
          .ok('Yes')
          .cancel('Cancel');
    $mdDialog.show(confirm).then(function() {
      attendee.remove().then(function () {
        //update the active flag against the attendee
        attendee.active = false;
      }, function (err) {
        $mdDialog.show(
           $mdDialog.alert()
            .parent(angular.element(document.querySelector('#attendeeList')))
            .clickOutsideToClose(true)
            .title('Cannot De-activate')
            .textContent(err)
            .ariaLabel('Unpublish Error')
  ...
  this.reactivateAttendee = function (attendee) {
    attendee.active = true;
    attendee.save();

  }

  this.saveAttendee = function (attendee) {
    attendee.put().then(function (attendee) {
      $rootScope.$emit('attendeeChange', attendee);
      $state.go('conference.attendees');
    });
  };;

  this.toggleImage = function (attendee, fieldName, alt) {
    //check if the image is ok
    if (attendee[fieldName]) {
      imageService.removeImage({
        className: 'Attendee',
        fieldName: fieldName,
        name: attendee.first + ' ' + attendee.last,
        object: attendee
      });
    } else {
      imageService.uploadImage({
        ...
        if (err) {
          ...
          attendee[fieldName] = imageDetails;
          attendee.save();
        }
      });
    }
...
.controller('AttendeeFormCtrl', function (attendee, Restangular, $state, $stateParams, COUNTRIES, ROLES, $rootScope) {
  'ngInject';
  ...
  var newAttendee = true;
  this.attendee = Restangular.copy(attendee);

  // same controller used for new attendees and editing attendees
  if (this.attendee.first) newAttendee = false;
  this.saveAttendee = function () {
    ...
    // };
    //
    // if (this.attendee.profilePic && this.attendee.profilePic !== attendee.profilePic) imageUploads.profilePic = true;
    // if (this.attendee.companyLogo && this.attendee.companyLogo !== attendee.companyLogo) imageUploads.companyLogo = true;
    //
    // imageService.uploadImage({
    //
    // })
    ...
    // console.log('called')
    if (newAttendee) {
      Restangular.one('conferences', $stateParams.confId).all('attendees').post(this.attendee).then(function (attendee) {
        // push the new attendee into the parent attendees list.
        $rootScope.$emit('attendeeChange', attendee);
        $state.go('conference.attendees');
      });
    }
    else {
      this.attendee.put().then(function (attendee) {
        $rootScope.$emit('attendeeChange', attendee);
        $state.go('conference.attendees');
      });
    }
  ...
  // this.removeAttendee = function () {
  //   Restangular.one('conferences', $stateParams.confId).one('attendees', $stateParams.attendeeId).remove().then(function (attendee) {
  //     $rootScope.$emit('removeAttendee', attendee);
  //     $state.go('conference.attendees');
  //   });
  // };
